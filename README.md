...
Update - 16/6/24 - Project uses a standalone version of alltalk_tts, it works pretty much the same as the TWGUI extension but has its own install location, read more here:<br>
